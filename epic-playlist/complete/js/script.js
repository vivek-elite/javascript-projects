...
buttonVivek.addEventListener("click", function () {
    ...
    buttonVivek.classList.add("active");
    buttonPriyanka.classList.remove("active");
...
buttonPriyanka.addEventListener("click", function () {
    ...
    mixList.classList.remove("hide");
    buttonPriyanka.classList.add("active");
    buttonVivek.classList.remove("active");
...
const mixInfo = function (mix) {
  ...
  mix.forEach(function (song, index) {
      ...
      li.innerHTML = `<div class="song-number">#${index + 1}</div>
        ...
        <a href="${song[1]}" target="_blank"><img src="img/youtube-logo.png"><br>Watch Video</a>
        </div>`;
      mixList.append(li);
  });
};
